...
const quizQuestions: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      {
        id: "q1b",
        text: "To redistribute surplus items to low-income communities while reducing emissions",
        isCorrect: true,
      },
  ...
  },
  {
    ...
    options: [
      {
        id: "q2a",
        text: "A circular economy keeps products and materials in use for as long as possible, reducing waste and extracting more value from every resource",
        isCorrect: true,
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "q3b",
        text: "The emissions saved when existing goods are reused instead of producing new ones",
        isCorrect: true,
      },
  ...
  },
  {
    ...
    options: [
      {
        id: "q4a",
        text: "Over 115t+ tonnes of surplus items were digitised and redistributed, reducing CO₂e",
        isCorrect: true,
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "q6b",
        text: "By ensuring usable goods reach children and workers who need them, improving lives",
        isCorrect: true,
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "q7b",
        text: "Become advocates for circular economy practices and share what they learned",
        isCorrect: true,
      },
    ...
    return (
      <div className="h-screen bg-[#1a1a1a] flex flex-col items-center justify-center p-4">
        ...
        >
          ...
          <h2 className="font-display font-bold text-2xl text-white mb-2">Training Complete!</h2>
          ...
          <div className="flex flex-col gap-3">
            ...
            <Button size="lg" variant="ghost" onClick={onComplete} className="w-full text-white/70 hover:text-white">
              Finish
            </Button>
          </div>
        </motion.div>
    ...
    <div className="h-screen bg-background flex flex-col overflow-hidden">
        ...
        <div className="w-full max-w-5xl">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* Question */}
              <p className="font-display font-semibold text-2xl md:text-3xl text-primary text-center max-w-3xl mx-auto">
                {currentQ.question}
              </p>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`${labelBgClass} py-2 border-t border-white/10`}>
                        <span className={`text-lg font-bold ${textClass}`}>{letter}</span>
                      </div>
                    </motion.button>
                  );
                })}
      ...
      <footer className="flex-shrink-0 py-6 px-8">
        <div className="flex justify-center gap-4 max-w-5xl mx-auto">
          <Button variant="outline" onClick={goToPrevious} disabled={currentQuestion === 0} className="min-w-[100px]">
