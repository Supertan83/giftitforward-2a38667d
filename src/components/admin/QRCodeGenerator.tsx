          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Create printable beneficiary cards</p>
              </div>
            </div>
      ...
      <main className="container max-w-6xl py-6 print:py-0 print:max-w-none">
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-display font-semibold text-lg">Generate Cards</h2>
          </div>
        ...
        <div ref={printRef} className="print:p-0">
          {cards.length === 0 ? (
            ...
            >
              ...
              <h3 className="font-display font-semibold text-lg mb-2">No Cards Generated</h3>
              <p className="text-muted-foreground mb-4">
                Generate QR cards above to preview and print them
              </p>
            </motion.div>
          ) : (
